 ...
 */
class listincsvbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "listincsv@listincsv";
    public $boxlabel;
    public $depends = array("listincsv");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/listincsv/class/listincsv.class.php";
